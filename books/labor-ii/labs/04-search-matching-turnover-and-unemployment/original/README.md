...
- the transition margin is unemployment to employment;
- the flow object is the aggregate job-finding hazard;
- the main diagnosis is whether changes in the aggregate hazard reflect matching efficiency or changing composition of job seekers.
